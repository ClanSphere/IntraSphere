...
<br />
<form method="post" id="lanpartys_create" action="{url:form}">
  <table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
    <tr>
    ...
    <tr>
      ...
      <td class="leftb">{lanpartys:abcode_bankaccount}<br />
        <textarea class="rte_abcode" name="lanpartys_bankaccount" cols="50" rows="5" id="lanpartys_bankaccount" ></textarea>
      </td>
    </tr>
    <tr>
      <td class="leftc">{icon:network_local} {lang:network}</td>
      <td class="leftb">{lanpartys:abcode_network}<br />
        <textarea class="rte_abcode" name="lanpartys_network" cols="50" rows="5" id="lanpartys_network" ></textarea>
      </td>
    </tr>
    <tr>
      <td class="leftc">{icon:joystick} {lang:tournaments}</td>
      <td class="leftb">{lanpartys:abcode_tournaments}<br />
        <textarea class="rte_abcode" name="lanpartys_tournaments" cols="50" rows="5" id="lanpartys_tournaments" ></textarea>
      </td>
    </tr>
    <tr>
      <td class="leftc">{icon:whatsnext} {lang:features}</td>
      <td class="leftb">{lanpartys:abcode_features}<br />
        <textarea class="rte_abcode" name="lanpartys_features" cols="50" rows="8" id="lanpartys_features" ></textarea>
      </td>
    </tr>
    <tr>
      <td class="leftc">{icon:kate} {lang:more}</td>
      <td class="leftb">{lanpartys:abcode_more}<br />
        <textarea class="rte_abcode" name="lanpartys_more" cols="50" rows="5" id="lanpartys_more" ></textarea>
      </td>
    </tr>
    <tr>
