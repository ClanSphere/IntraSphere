...
<form method="post" id="lanpartys_options" action="{url:form}">
  <table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
    <tr>
      ...
      <td class="leftb"><input type="text" name="max_width" value="{lanpartys:max_width}" maxlength="4" size="4"  />
        {lang:pixel}</td>
    </tr>
    <tr>
      <td class="leftc">{icon:resizerow} {lang:max_height}</td>
      <td class="leftb"><input type="text" name="max_height" value="{lanpartys:max_height}" maxlength="4" size="4"  />
        {lang:pixel}</td>
    </tr>
    <tr>
      <td class="leftc">{icon:fileshare} {lang:max_size}</td>
      <td class="leftb"><input type="text" name="max_size" value="{lanpartys:max_size}" maxlength="20" size="8"  />
        {lang:bytes}</td>
    </tr>
    <tr>
