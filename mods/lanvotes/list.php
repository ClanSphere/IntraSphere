...
// $Id: list.php 1775 2009-02-17 20:59:11Z duRiel $
...
$data['lang']['all'] = sprintf($cs_lang['all_votes'],$lanvotes_count);
$data['pages']['list'] = cs_pages('lanvotes','list',$lanvotes_count,$start,$lanpartys_id,$sort);
$data['lang']['select'] = $cs_lang['select_lan'];
$data['url']['form'] = cs_url('lanvotes','list');
...
$data['sort']['question'] = cs_sort('lanvotes','list',$start,$lanpartys_id,1,$sort);
$data['sort']['start'] = cs_sort('lanvotes','list',$start,$lanpartys_id,3,$sort);
$data['sort']['end'] = cs_sort('lanvotes','list',$start,$lanpartys_id,5,$sort);
